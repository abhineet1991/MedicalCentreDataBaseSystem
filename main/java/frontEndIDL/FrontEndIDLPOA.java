 ...
 */
public abstract class FrontEndIDLPOA extends org.omg.PortableServer.Servant
        implements FrontEndIDLOperations, org.omg.CORBA.portable.InvokeHandler
{
    public FrontEndIDL _this()
    {
        return FrontEndIDLHelper.narrow(_this_object());
    }

    public FrontEndIDL _this(org.omg.CORBA.ORB orb)
    {
        return FrontEndIDLHelper.narrow(_this_object(orb));
    }
            ...
            final org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        } else if (opName.equals("getCount")) {
                return _invoke_getCount(_is, handler);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getCount(
            final org.omg.CORBA.portable.InputStream _is,
            final org.omg.CORBA.portable.ResponseHandler handler) {
        org.omg.CORBA.portable.OutputStream _output;
        String arg0_in = _is.read_string();
        ...
        String _arg_result = getCount(arg0_in, arg1_in);
