...
public class ClinicServerImpl implements Runnable {
	...
	public String createDRecord(String managerId, String firstName, String lastName, String address, String phone, String specialization,
		...
		String result = "fail";
		if (location.equalsIgnoreCase(DRecord.LOCATION_SAN_JOSE) || location.equalsIgnoreCase(DRecord.LOCATION_SAN_FRANSISCO)
					...
					if (record.getRecordId().equals(recordID)) {
						...
						synchronized (record) {
							...
							case Phone:
								...
								break;
							case Location:
								if (newValue.equalsIgnoreCase(DRecord.LOCATION_SAN_JOSE)
										|| newValue.equalsIgnoreCase(DRecord.LOCATION_SAN_FRANSISCO)
